...
describe("TicketManager", () => {
  ...
  beforeEach(async () => {
    ...
    tokenMaster = await TicketManager.deploy(NAME, SYMBOL)
  ...
  describe("Events", () => {
    it('Returns occasions attributes', async () => {
      const occasion = await tokenMaster.getEvent(1)
  ...
  describe("Minting", () => {
    ...
    beforeEach(async () => {
      const transaction = await tokenMaster.connect(buyer).purchaseTicket(ID, SEAT, { value: AMOUNT })
      await transaction.wait()
    })
  ...
  describe("Withdrawing", () => {
    ...
    beforeEach(async () => {
      ...
      let transaction = await tokenMaster.connect(buyer).purchaseTicket(ID, SEAT, { value: AMOUNT })
      await transaction.wait()
